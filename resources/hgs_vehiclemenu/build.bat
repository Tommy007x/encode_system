@echo off
REM Step 1: Check if the folder named 'resources' exists in the current directory path

REM Extract the current directory path
setlocal enabledelayedexpansion
set currentPath=%cd%

REM Split the current path using backslashes and reconstruct the path up to 'resources'
set "resourcePath="
set "foundResource=0"
...
if %foundResource%==1 (
	...
	REM Run build.exe located in the resources path with additional arguments
